...
const test_t test_se_only[] = {
	...
	{{0x88, 0x18, 0x00, 0x00}, SZ_SE , "se_lbz r1 0x20(r8)"},
	{{0x9A, 0x02, 0x00, 0x00}, SZ_SE , "se_stb r0 0x28(r2)"},
	{{0xA9, 0x84, 0x00, 0x00}, SZ_SE , "se_lbh r24 0x24(r4)"},
	{{0xB6, 0x1E, 0x00, 0x00}, SZ_SE , "se_sth r1 0x18(r14)"},
...
const test_t test_e_only[] = {
	...
	{{0x18, 0xA3, 0xAB, 0x37}, SZ_E  , "e_cmpli cr5 r3 0x37000000"},
	...
	{{0x71, 0x3F, 0xCE, 0xED}, SZ_E  , "e_and2i. r9 0xffffeed"},
	{{0x71, 0x40, 0xE8, 0x05}, SZ_E  , "e_and2is. r10 0x5"},
	{{0x73, 0xE1, 0xAE, 0xE0}, SZ_E  , "e_cmpl16i r1 0xfffffee0"},
	...
	{{0x7C, 0x20, 0x5C, 0x71}, SZ_E  , "e_srwi. r0 r0 0xb"},
	{{0x7C, 0x20, 0x84, 0x70}, SZ_E  , "e_srwi r0 r0 0x10"},
	{{0x7C, 0x48, 0x02, 0x31}, SZ_E  , "e_rlw. r0 r8 r0"},
	{{0x7C, 0x62, 0xAA, 0x71}, SZ_E  , "e_rlwi. r0 r2 0x15"},
	{{0x7C, 0x74, 0xAA, 0x70}, SZ_E  , "e_rlwi r0 r20 0x15"},
	{{0x7C, 0x87, 0x58, 0x1C}, SZ_E  , "e_cmph cr0 r7 r11"},
	{{0x7C, 0x98, 0x00, 0x20}, SZ_E  , "e_mcrf cr1 cr6"},
	{{0x7D, 0x4C, 0xA0, 0x71}, SZ_E  , "e_slwi. r1 r12 0x14"},
	...
	{{0x7E, 0x6C, 0x30, 0x70}, SZ_E  , "e_slwi r2 r12 0x6"},
...
const test_t test_gh_issues[] = {
	...
	{{0x70, 0xD8, 0xE3, 0xFE}, SZ_E  , "e_lis r6 0xfffc3fe"},
	...
	{{0x7C, 0x64, 0x18, 0xF8}, SZ_PPC, "nor r3 r4 r3"},
	...
	{{0x7C, 0xC0, 0x20, 0xF8}, SZ_PPC, "nor r6 r0 r4"},
	{{0x7C, 0xC0, 0x20, 0xF9}, SZ_PPC, "nor. r6 r0 r4"},
	{{0x7C, 0xC0, 0x23, 0x78}, SZ_PPC, "or r6 r0 r4"},
	{{0x7C, 0xC0, 0x23, 0x79}, SZ_PPC, "or. r6 r0 r4"},
