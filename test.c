...
const test_t test_e_only[] = {
	...
	{{0x79, 0xFF, 0xFE, 0x67}, SZ_E  , "e_bl 0xfffffe66"},
	{{0x79, 0xFF, 0xFF, 0x82}, SZ_E  , "e_b 0xffffff82"},
...
const test_t test_gh_issues[] = {
	...
	{{0x79, 0xFF, 0xAF, 0x09}, SZ_E  , "e_bl 0xffffaf08"},
	...
	{{0x78, 0x05, 0x0C, 0x61}, SZ_E  , "e_bl 0x50c60"},
	{{0x79, 0xFA, 0xCB, 0x5F}, SZ_E  , "e_bl 0xfffacb5e"},
	{{0x79, 0xF6, 0x9B, 0xAF}, SZ_E  , "e_bl 0xfff69bae"},
	{{0x79, 0xFA, 0xCB, 0x59}, SZ_E  , "e_bl 0xfffacb58"},
	/* PowerPC related */
