...
//	{ "name"       , op        , mask                    , type   , {TYPE_REG, TYPE_REG, TYPE_REG, TYPE_REG, TYPE_REG}}
	...
	{ "and"        , 0x7C000038, 0x7C000038 | F_MASK_X   ,   F_XRA, {TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE}},
	{ "and."       , 0x7C000038, 0x7C000039 | F_MASK_X   ,   F_XRA, {TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE}},
	{ "andc"       , 0x7C000078, 0x7C000078 | F_MASK_X   ,   F_XRA, {TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE}},
	{ "andc."      , 0x7C000078, 0x7C000079 | F_MASK_X   ,   F_XRA, {TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE}},
	...
	{ "lbzux"      , 0x7C0000EE, 0x7C0000EE | F_MASK_X   ,     F_X, {TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE}},
	{ "lbzx"       , 0x7C0000AE, 0x7C0000AE | F_MASK_X   ,     F_X, {TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE}},
	...
	{ "mbar"       , 0x7C0006AC, 0x7C0006AC | F_MASK_XFX ,   F_XFX, {TYPE_IMM, TYPE_NONE, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
	{ "mfctr"      , 0x7C0902A6, 0x7C1902A6 | F_MASK_MTPR,  F_MTPR, {TYPE_NONE, TYPE_REG, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
	{ "mtctr"      , 0x7C0903A6, 0x7C1903A6 | F_MASK_MTPR,  F_MTPR, {TYPE_NONE, TYPE_REG, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
	{ "mcrxr"      , 0x7C000400, 0x7C000400 | F_MASK_XER ,   F_XER, {TYPE_IMM, TYPE_NONE, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
	{ "mfcr"       , 0x7C000026, 0x7C000026 | E_MASK_XL  ,   F_XFX, {TYPE_REG, TYPE_NONE, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
	...
	{ "mfpmr"      , 0x7C00029C, 0x7C00029C | F_MASK_XFX ,   F_XFX, {TYPE_REG, TYPE_IMM, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
	...
	{ "mulhw"      , 0x7C000096, 0x7C000096 | F_MASK_XO  ,    F_XO, {TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE}},
	{ "mulhw."     , 0x7C000096, 0x7C000097 | F_MASK_XO  ,    F_XO, {TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE}},
	{ "mulhwu"     , 0x7C000016, 0x7C000016 | F_MASK_XO  ,    F_XO, {TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE}},
	{ "mulhwu."    , 0x7C000016, 0x7C000017 | F_MASK_XO  ,    F_XO, {TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE}},
	...
	{ "neg"        , 0x7C0000D0, 0x7C0000D0 | F_MASK_X   ,     F_X, {TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
	{ "neg."       , 0x7C0000D0, 0x7C0000D1 | F_MASK_X   ,     F_X, {TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
	{ "nego"       , 0x7C0004D0, 0x7C0004D0 | F_MASK_X   ,     F_X, {TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
	{ "nego."      , 0x7C0004D0, 0x7C0004D1 | F_MASK_X   ,     F_X, {TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
	{ "nor"        , 0x7C0000F8, 0x7C0000F8 | F_MASK_X   ,   F_XRA, {TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE}},
	{ "nor."       , 0x7C0000F8, 0x7C0000F9 | F_MASK_X   ,   F_XRA, {TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE}},
	{ "or"         , 0x7C000378, 0x7C000378 | F_MASK_X   ,   F_XRA, {TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE}},
	{ "or."        , 0x7C000378, 0x7C000379 | F_MASK_X   ,   F_XRA, {TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE}},
	{ "orc"        , 0x7C000338, 0x7C000338 | F_MASK_X   ,   F_XRA, {TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE}},
	{ "orc."       , 0x7C000338, 0x7C000339 | F_MASK_X   ,   F_XRA, {TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE}},
	{ "slw"        , 0x7C000030, 0x7C000030 | F_MASK_X   ,     F_X, {TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE}},
	{ "slw."       , 0x7C000030, 0x7C000031 | F_MASK_X   ,     F_X, {TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE}},
	{ "sraw"       , 0x7C000630, 0x7C000630 | F_MASK_X   ,     F_X, {TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE}},
	{ "sraw."      , 0x7C000630, 0x7C000631 | F_MASK_X   ,     F_X, {TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE}},
	{ "srawi"      , 0x7C000670, 0x7C000670 | F_MASK_X   ,     F_X, {TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE}},
	{ "srawi."     , 0x7C000670, 0x7C000671 | F_MASK_X   ,     F_X, {TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE}},
	{ "srw"        , 0x7C000430, 0x7C000430 | F_MASK_X   ,     F_X, {TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE}},
	{ "srw."       , 0x7C000430, 0x7C000431 | F_MASK_X   ,     F_X, {TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE}},
	{ "stbux"      , 0x7C0001EE, 0x7C0001EE | F_MASK_X   ,     F_X, {TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE}},
	{ "stbx"       , 0x7C0001AE, 0x7C0001AE | E_MASK_XL  ,     F_X, {TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE}},
	{ "sthux"      , 0x7C00036E, 0x7C00036E | F_MASK_X   ,     F_X, {TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE}},
	{ "sthx"       , 0x7C00032E, 0x7C00032E | F_MASK_X   ,     F_X, {TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE}},
	...
	{ "subf"       , 0x7C000050, 0x7C000050 | F_MASK_XO  ,    F_XO, {TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE}},
	{ "subf."      , 0x7C000050, 0x7C000051 | F_MASK_XO  ,    F_XO, {TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE}},
	{ "subfc"      , 0x7C000010, 0x7C000010 | F_MASK_XO  ,    F_XO, {TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE}},
	{ "subfc."     , 0x7C000010, 0x7C000011 | F_MASK_XO  ,    F_XO, {TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE}},
	{ "subfco"     , 0x7C000410, 0x7C000410 | F_MASK_XO  ,    F_XO, {TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE}},
	{ "subfco."    , 0x7C000410, 0x7C000411 | F_MASK_XO  ,    F_XO, {TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE}},
	{ "subfe"      , 0x7C000110, 0x7C000110 | F_MASK_XO  ,    F_XO, {TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE}},
	{ "subfe."     , 0x7C000110, 0x7C000111 | F_MASK_XO  ,    F_XO, {TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE}},
	{ "subfeo"     , 0x7C000510, 0x7C000510 | F_MASK_XO  ,    F_XO, {TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE}},
	{ "subfeo."    , 0x7C000510, 0x7C000511 | F_MASK_XO  ,    F_XO, {TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE}},
	{ "subfo"      , 0x7C000050, 0x7C000450 | F_MASK_XO  ,    F_XO, {TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE}},
	{ "subfo."     , 0x7C000050, 0x7C000451 | F_MASK_XO  ,    F_XO, {TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE}},
	{ "subfze"     , 0x7C000190, 0x7C000190 | F_MASK_XO  ,    F_XO, {TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE}},
	{ "subfze."    , 0x7C000190, 0x7C000191 | F_MASK_XO  ,    F_XO, {TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE}},
	{ "subfzeo"    , 0x7C000590, 0x7C000590 | F_MASK_XO  ,    F_XO, {TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE}},
	{ "subfzeo."   , 0x7C000590, 0x7C000591 | F_MASK_XO  ,    F_XO, {TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE}},
	...
	{ "wrtee"      , 0x7C000106, 0x7C000106 | E_MASK_XL  ,     F_X, {TYPE_REG, TYPE_NONE, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
...
//	{ "name"        , op        , mask                    , type    , {TYPE_REG, TYPE_REG, TYPE_REG, TYPE_REG, TYPE_REG}}
	...
	{ "e_and2i."    , 0x7000C800, 0x7000C800 | E_MASK_I16L, E_I16L  , {TYPE_REG, TYPE_IMM, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
	{ "e_and2is."   , 0x7000E800, 0x7000E800 | E_MASK_I16L, E_I16LS , {TYPE_REG, TYPE_IMM, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
	...
	// has cr0-cr3   
	{ "e_bge"       , 0x7A000000, 0x7A000000 | E_MASK_BD15, E_BD15  , {TYPE_CR, TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
	{ "e_ble"       , 0x7A000000, 0x7A010000 | E_MASK_BD15, E_BD15  , {TYPE_CR, TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
	{ "e_bne"       , 0x7A000000, 0x7A020000 | E_MASK_BD15, E_BD15  , {TYPE_CR, TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
	{ "e_bns"       , 0x7A000000, 0x7A030000 | E_MASK_BD15, E_BD15  , {TYPE_CR, TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
	{ "e_blt"       , 0x7A000000, 0x7A100000 | E_MASK_BD15, E_BD15  , {TYPE_CR, TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
	{ "e_bgt"       , 0x7A000000, 0x7A110000 | E_MASK_BD15, E_BD15  , {TYPE_CR, TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
	{ "e_beq"       , 0x7A000000, 0x7A120000 | E_MASK_BD15, E_BD15  , {TYPE_CR, TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
	{ "e_bso"       , 0x7A000000, 0x7A130000 | E_MASK_BD15, E_BD15  , {TYPE_CR, TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
	{ "e_bc"        , 0x7A000000, 0x7A140000 | E_MASK_BD15, E_BD15  , {TYPE_CR, TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
	{ "e_bgel"      , 0x7A000001, 0x7A000001 | E_MASK_BD15, E_BD15  , {TYPE_CR, TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
	{ "e_blel"      , 0x7A000001, 0x7A010001 | E_MASK_BD15, E_BD15  , {TYPE_CR, TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
	{ "e_bnel"      , 0x7A000001, 0x7A020001 | E_MASK_BD15, E_BD15  , {TYPE_CR, TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
	{ "e_bnsl"      , 0x7A000001, 0x7A030001 | E_MASK_BD15, E_BD15  , {TYPE_CR, TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
	{ "e_bltl"      , 0x7A000001, 0x7A110001 | E_MASK_BD15, E_BD15  , {TYPE_CR, TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
	{ "e_bgtl"      , 0x7A000001, 0x7A120001 | E_MASK_BD15, E_BD15  , {TYPE_CR, TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
	{ "e_beql"      , 0x7A000001, 0x7A130001 | E_MASK_BD15, E_BD15  , {TYPE_CR, TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
	{ "e_bsol"      , 0x7A000001, 0x7A140001 | E_MASK_BD15, E_BD15  , {TYPE_CR, TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
	{ "e_bcl"       , 0x7A000001, 0x7A140001 | E_MASK_BD15, E_BD15  , {TYPE_CR, TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
	// has cr0-cr3    
	{ "e_bdnz"      , 0x7A200000, 0x7A200000 | E_MASK_BD15, E_BD15c , {TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
	{ "e_bdnzl"     , 0x7A200001, 0x7A200001 | E_MASK_BD15, E_BD15c , {TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
	{ "e_bdz"       , 0x7A300000, 0x7A300000 | E_MASK_BD15, E_BD15c , {TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
	{ "e_bdzl"      , 0x7A300001, 0x7A300001 | E_MASK_BD15, E_BD15c , {TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
	...
	{ "e_bc"        , 0x7A000000, 0x7A200000 | E_MASK_BD15, E_BD15b , {TYPE_IMM, TYPE_IMM, TYPE_JMP, TYPE_NONE, TYPE_NONE}},
	{ "e_bcl"       , 0x7A000001, 0x7A200001 | E_MASK_BD15, E_BD15b , {TYPE_IMM, TYPE_IMM, TYPE_JMP, TYPE_NONE, TYPE_NONE}},
	...
	{ "e_cmphl16i"  , 0x7000B800, 0x7000B800 | E_MASK_IA16, E_IA16U , {TYPE_IMM, TYPE_REG, TYPE_IMM, TYPE_NONE, TYPE_NONE}},
	{ "e_cmpl16i"   , 0x7000A800, 0x7000A800 | E_MASK_IA16, E_IA16U , {TYPE_IMM, TYPE_REG, TYPE_IMM, TYPE_NONE, TYPE_NONE}},
	{ "e_cmpli"     , 0x1880A800, 0x1880A800 | E_MASK_SCI8, E_SCI8CR, {TYPE_CR, TYPE_REG, TYPE_IMM, TYPE_IMM, TYPE_IMM}},
	{ "e_cmpi"      , 0x1800A800, 0x1800A800 | E_MASK_SCI8, E_SCI8CR, {TYPE_CR, TYPE_REG, TYPE_IMM, TYPE_IMM, TYPE_IMM}},
	...
	{ "e_lbz"       , 0x30000000, 0x30000000 | E_MASK_D   , E_D     , {TYPE_REG, TYPE_REG, TYPE_MEM, TYPE_NONE, TYPE_NONE}},
	{ "e_lbzu"      , 0x18000000, 0x18000000 | E_MASK_D8  , E_D8    , {TYPE_REG, TYPE_REG, TYPE_MEM, TYPE_NONE, TYPE_NONE}},
	{ "e_lha"       , 0x38000000, 0x38000000 | E_MASK_D   , E_D     , {TYPE_REG, TYPE_REG, TYPE_MEM, TYPE_NONE, TYPE_NONE}},
	{ "e_lhau"      , 0x18000300, 0x18000300 | E_MASK_D8  , E_D8    , {TYPE_REG, TYPE_REG, TYPE_MEM, TYPE_NONE, TYPE_NONE}},
	{ "e_lhz"       , 0x58000000, 0x58000000 | E_MASK_D   , E_D     , {TYPE_REG, TYPE_REG, TYPE_MEM, TYPE_NONE, TYPE_NONE}},
	{ "e_lhzu"      , 0x18000100, 0x18000100 | E_MASK_D8  , E_D8    , {TYPE_REG, TYPE_REG, TYPE_MEM, TYPE_NONE, TYPE_NONE}},
	{ "e_li"        , 0x70000000, 0x70000000 | E_MASK_LI20, E_LI20  , {TYPE_REG, TYPE_IMM, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
	{ "e_lis"       , 0x7000E000, 0x7000E000 | E_MASK_I16L, E_I16LS , {TYPE_REG, TYPE_IMM, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
	{ "e_lmw"       , 0x18000800, 0x18000800 | E_MASK_D8  , E_D8    , {TYPE_REG, TYPE_REG, TYPE_MEM, TYPE_NONE, TYPE_NONE}},
	{ "e_lwz"       , 0x50000000, 0x53000000 | E_MASK_D   , E_D     , {TYPE_REG, TYPE_REG, TYPE_MEM, TYPE_NONE, TYPE_NONE}},
	{ "e_lwzu"      , 0x18000200, 0x18000200 | E_MASK_D8  , E_D8    , {TYPE_REG, TYPE_REG, TYPE_MEM, TYPE_NONE, TYPE_NONE}},
	...
	{ "e_or2i"      , 0x7000C000, 0x7000C000 | E_MASK_I16L, E_I16L  , {TYPE_REG, TYPE_IMM, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
	{ "e_or2is"     , 0x7000D000, 0x7000D000 | E_MASK_I16L, E_I16LS , {TYPE_REG, TYPE_IMM, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
	...
	{ "e_stb"       , 0x34000000, 0x34000000 | E_MASK_D   , E_D     , {TYPE_REG, TYPE_REG, TYPE_MEM, TYPE_NONE, TYPE_NONE}},
	{ "e_stbu"      , 0x18000400, 0x18000400 | E_MASK_D8  , E_D8    , {TYPE_REG, TYPE_REG, TYPE_MEM, TYPE_NONE, TYPE_NONE}},
	{ "e_sth"       , 0x5C000000, 0x5C000000 | E_MASK_D   , E_D     , {TYPE_REG, TYPE_REG, TYPE_MEM, TYPE_NONE, TYPE_NONE}},
	{ "e_sthu"      , 0x18000500, 0x18000500 | E_MASK_D8  , E_D8    , {TYPE_REG, TYPE_REG, TYPE_MEM, TYPE_NONE, TYPE_NONE}},
	{ "e_stmw"      , 0x18000900, 0x18000900 | E_MASK_D8  , E_D8    , {TYPE_REG, TYPE_REG, TYPE_MEM, TYPE_NONE, TYPE_NONE}},
	{ "e_stw"       , 0x54000000, 0x56000000 | E_MASK_D   , E_D     , {TYPE_REG, TYPE_REG, TYPE_MEM, TYPE_NONE, TYPE_NONE}},
	{ "e_stwu"      , 0x18000600, 0x18000600 | E_MASK_D8  , E_D8    , {TYPE_REG, TYPE_REG, TYPE_MEM, TYPE_NONE, TYPE_NONE}},
	...
	{ "e_ldmvcsrrw" , 0x18A01000, 0x18A01000 | E_MASK_D8  , E_D8_N  , {TYPE_REG, TYPE_MEM, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
	{ "e_ldmvdsrrw" , 0x18C01000, 0x18C01000 | E_MASK_D8  , E_D8_N  , {TYPE_REG, TYPE_MEM, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
	{ "e_ldmvgprw"  , 0x18001000, 0x18001000 | E_MASK_D8  , E_D8_N  , {TYPE_REG, TYPE_MEM, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
	{ "e_ldmvsprw"  , 0x18201000, 0x18201000 | E_MASK_D8  , E_D8_N  , {TYPE_REG, TYPE_MEM, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
	{ "e_ldmvsrrw"  , 0x18801000, 0x18801000 | E_MASK_D8  , E_D8_N  , {TYPE_REG, TYPE_MEM, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
	{ "e_lmvcsrrw"  , 0x18A01000, 0x18A01000 | E_MASK_D8  , E_D8_N  , {TYPE_REG, TYPE_MEM, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
	{ "e_lmvdsrrw"  , 0x18C01000, 0x18C01000 | E_MASK_D8  , E_D8_N  , {TYPE_REG, TYPE_MEM, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
	{ "e_lmvgprw"   , 0x18001000, 0x18001000 | E_MASK_D8  , E_D8_N  , {TYPE_REG, TYPE_MEM, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
	{ "e_lmvmcsrrw" , 0x18E01000, 0x18E01000 | E_MASK_D8  , E_D8_N  , {TYPE_REG, TYPE_MEM, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
	{ "e_lmvsprw"   , 0x18201000, 0x18201000 | E_MASK_D8  , E_D8_N  , {TYPE_REG, TYPE_MEM, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
	{ "e_lmvsrrw"   , 0x18801000, 0x18801000 | E_MASK_D8  , E_D8_N  , {TYPE_REG, TYPE_MEM, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
	{ "e_stmvcsrrw" , 0x18A01100, 0x18A01100 | E_MASK_D8  , E_D8_N  , {TYPE_REG, TYPE_MEM, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
	{ "e_stmvdsrrw" , 0x18C01100, 0x18C01100 | E_MASK_D8  , E_D8_N  , {TYPE_REG, TYPE_MEM, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
	{ "e_stmvgprw"  , 0x18001100, 0x18001100 | E_MASK_D8  , E_D8_N  , {TYPE_REG, TYPE_MEM, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
	{ "e_stmvmcsrrw", 0x18E01100, 0x18E01000 | E_MASK_D8  , E_D8_N  , {TYPE_REG, TYPE_MEM, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
	{ "e_stmvsprw"  , 0x18201100, 0x18201100 | E_MASK_D8  , E_D8_N  , {TYPE_REG, TYPE_MEM, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
	{ "e_stmvsrrw"  , 0x18801100, 0x18801100 | E_MASK_D8  , E_D8_N  , {TYPE_REG, TYPE_MEM, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
};
...
//	{ "name"      , op    , mask  , n,   op_type           , {{field ,shl,shr,  +, i, TYPE_REG}, ...}
	...
	{ "se_lbz"    , 0x8000, 0x8FFF, 3, {{0x0F00,  8,  0,  0, 2, TYPE_MEM}, {0x00F0,  4,  0,  0,  0, TYPE_REG}, {0x000F,  0,  0,  0,  1, TYPE_REG}, {0}, {0}}},
	{ "se_lbh"    , 0xA000, 0xAFFF, 3, {{0x0F00,  7,  0,  0, 2, TYPE_MEM}, {0x00F0,  4,  0,  0,  0, TYPE_REG}, {0x000F,  0,  0,  0,  1, TYPE_REG}, {0}, {0}}},
	{ "se_li"     , 0x4800, 0x4FFF, 2, {{0x07F0,  4,  0,  0, 1, TYPE_IMM}, {0x000F,  0,  0,  0,  0, TYPE_REG}, {0}, {0}, {0}}},
	{ "se_lwz"    , 0xC000, 0xCFFF, 3, {{0x0F00,  6,  0,  0, 2, TYPE_MEM}, {0x00F0,  4,  0,  0,  0, TYPE_REG}, {0x000F,  0,  0,  0,  1, TYPE_REG}, {0}, {0}}},
	...
	{ "se_stb"    , 0x9000, 0x9FFF, 3, {{0x0F00,  8,  0,  0, 2, TYPE_MEM}, {0x00F0,  4,  0,  0,  0, TYPE_REG}, {0x000F,  0,  0,  0,  1, TYPE_REG}, {0}, {0}}},
	{ "se_sth"    , 0xB000, 0xBFFF, 3, {{0x0F00,  7,  0,  0, 2, TYPE_MEM}, {0x00F0,  4,  0,  0,  0, TYPE_REG}, {0x000F,  0,  0,  0,  1, TYPE_REG}, {0}, {0}}},
	{ "se_stw"    , 0xD000, 0xDFFF, 3, {{0x0F00,  6,  0,  0, 2, TYPE_MEM}, {0x00F0,  4,  0,  0,  0, TYPE_REG}, {0x000F,  0,  0,  0,  1, TYPE_REG}, {0}, {0}}},
...
vle_t* vle_next(vle_handle* handle) {
	...
	if (handle->pos + 4 <= handle->end) {
		op = find_ppc (handle->pos, handle->addr);
	}
	if (!op && handle->pos + 4 <= handle->end) {
		op = find_e (handle->pos, handle->addr);
	}
	if (!op && handle->pos + 2 <= handle->end) {
		op = find_se (handle->pos, handle->addr);
	}

	handle->inc = op ? op->size : 0;
	handle->addr += op ? op->size : 0;
	return op;
}
